...
public class ChronoAnchor extends SpellComponent {
    ...
    public boolean applyEffectEntity(ItemStack stack, World world, LivingEntity caster, Entity target) {
        if (target instanceof LivingEntity){
            ...
            if (!world.isRemote) {
//                if (((LivingEntity)target).getActivePotionEffects().contains(BuffEffectTemporalAnchor.class)) ((LivingEntity)target).getActivePotionEffects().remove(BuffEffectTemporalAnchor.class);
