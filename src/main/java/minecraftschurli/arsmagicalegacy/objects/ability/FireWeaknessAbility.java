...
public final class FireWeaknessAbility extends AbstractAffinityAbility {
    private static final AttributeModifier MODIFIER = new AttributeModifier("fire_weakness", -0.25, AttributeModifier.Operation.ADDITION);
