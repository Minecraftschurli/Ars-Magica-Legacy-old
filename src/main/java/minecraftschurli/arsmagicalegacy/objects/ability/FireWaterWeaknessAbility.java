...
public final class FireWaterWeaknessAbility extends AbstractAffinityAbility {
    private static final AttributeModifier MODIFIER = new AttributeModifier("fire_water_weakness", -0.25, AttributeModifier.Operation.ADDITION);
