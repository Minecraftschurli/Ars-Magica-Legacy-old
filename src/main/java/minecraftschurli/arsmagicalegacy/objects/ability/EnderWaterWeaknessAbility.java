...
public final class EnderWaterWeaknessAbility extends AbstractAffinityAbility {
    private static final AttributeModifier MODIFIER = new AttributeModifier("ender_water_weakness", -0.25, AttributeModifier.Operation.ADDITION);
