...
public class AMLGermanLanguageProvider extends LanguageProvider implements ArsMagicaLanguagePlugin {
    ...
    protected void addTranslations() {
        ...
        addCategoryTranslation("guide", "Tutorials", "");
        addCategoryTranslation("mechanic", "Mechaniken", "");
        addCategoryTranslation("mechanic.affinity", "Affinitäten", "");
        addCategoryTranslation("mechanic.enchants", "Verzauberungen", "");
        addCategoryTranslation("mechanic.infusions", "Infusionen", "");
        addCategoryTranslation("item", "Items", "");
        addCategoryTranslation("item.ore", "Erze", "");
        addCategoryTranslation("item.essence", "Essenz", "");
        addCategoryTranslation("item.rune", "Runen", "");
        addCategoryTranslation("item.armor", "Rüstung", "");
        addCategoryTranslation("item.armor.mage", "Magierrüstung", "");
        addCategoryTranslation("item.armor.battlemage", "Kampfmagierrüstung", "");
        addCategoryTranslation("item.affinity_tomes", "Affinitätslexika", "");
        addCategoryTranslation("item.foci", "Foki", "");
        addCategoryTranslation("item.mana_potion", "Manatränke", "");
        addCategoryTranslation("item.binding_catalyst", "Bindungskristalle", "");
        addCategoryTranslation("item.flickerfocus", "Flickerfokus", "");
        addCategoryTranslation("item.inscription_upgrades", "Upgrades für den Magischen Schreibtisch", "");
        addCategoryTranslation("block", "Blöcke", "");
        addCategoryTranslation("block.illusion_blocks", "Illusionsblöcke", "");
        addCategoryTranslation("block.crystalmarker", "Kristallmarker", "");
        addCategoryTranslation("block.inlays", "Gravuren", "");
        addCategoryTranslation("shape", "Formen", "");
        addCategoryTranslation("component", "Komponenten", "");
        addCategoryTranslation("modifier", "Modifizierer", "");
        addCategoryTranslation("talent", "Talente", "");
        addCategoryTranslation("mob", "Mobs", "");
        addCategoryTranslation("mob.flicker", "Flicker", "");
        addCategoryTranslation("structure", "Strukturen", "");
        addCategoryTranslation("boss", "Bosse", "");
    }
