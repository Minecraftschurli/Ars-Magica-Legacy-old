...
public class AMLEnglishLanguageProvider extends LanguageProvider implements ArsMagicaLanguagePlugin {
    ...
    protected void addTranslations() {
        ...
        addTextPage("block", "aum", 0, "");
        addTextPage("block", "cerublossom", 0, "");
        addTextPage("block", "desert_nova", 0, "");
        addTextPage("block", "tarma_root", 0, "");
        addTextPage("block", "wakebloom", 0, "");
        addTextPage("block", "inlay", 0, "");
        addTextPage("block", "altar_core", 0, "");
        addTextPage("block", "draining_well", 0, "");
        addTextPage("block", "essence_refiner", 0, "");
        addTextPage("block", "everstone", 0, "");
        addTextPage("block", "flicker_lure", 0, "");
        addTextPage("block", "inscription_table", 0, "");
        ...
        addTextPage("mechanic", "burnout", 0, "");
        addTextPage("mechanic", "crafting_altar", 0, "");
        addTextPage("mechanic", "magic_level", 0, "");
        addTextPage("mechanic", "mana", 0, "");
        addTextPage("mechanic", "silver_skills", 0, "");
        addTextPage("mechanic", "spell_creation", 0, "");
    }
