...
public class AMLEnglishLanguageProvider extends LanguageProvider implements ArsMagicaLanguagePlugin {
    ...
    protected void addTranslations() {
        ...
        addTextPageTranslation("guide", "your_first_spell", 2, "Create a shape group by dragging shapes and/or modifiers from the source region to any of the shape groups in the interface. You can create multiple shape groups in the same spell, three by default. Each shape group can have up to four shapes/modifiers. Shape groups cannot contain components. A good way to think about it is that shape groups are different means of targeting things with the spell, then the spell grammar is what the spell actually does.");
        addTextPageTranslation("guide", "your_first_spell", 3, "Once your shape groups are created, drag the spell parts you want, in order, from the source region to the spell grammar section. The spell grammar section can contain spell shapes, components, and modifiers in addition to the shape groups. Once your combination is completed, go to your $(l:crafting_altar)Crafting Altar$() and place your book containing the spell recipe on the lectern.");
        addTextPageTranslation("guide", "your_first_spell", 4, "Throw a $(l:rune)blank rune$() into the middle of the crafting altar to begin the process, then follow the book's prompts. The book itself is worth reading as well, as it contains a recap of what the spell recipe is for, the materials list for the spell and an affinity breakdown of the spell. Note that certain crafting altars can only craft spells that are so powerful. Too much power and bad things can happen. See the entry on the $(l:crafting_altar)Crafting Altar$() for more information.");
        addTextPageTranslation("block", "aum", 0, "");
        addTextPageTranslation("block", "cerublossom", 0, "");
        addTextPageTranslation("block", "desert_nova", 0, "");
        addTextPageTranslation("block", "tarma_root", 0, "");
        addTextPageTranslation("block", "wakebloom", 0, "");
        addTextPageTranslation("block", "inlay", 0, "");
        addTextPageTranslation("block", "altar_core", 0, "");
        addTextPageTranslation("block", "draining_well", 0, "");
        addTextPageTranslation("block", "essence_refiner", 0, "");
        addTextPageTranslation("block", "everstone", 0, "");
        addTextPageTranslation("block", "flicker_lure", 0, "");
        addTextPageTranslation("block", "inscription_table", 0, "");
        addTextPageTranslation("block", "inscription_table", 1, "");
        addTextPageTranslation("block", "keystone_door", 0, "");
        addTextPageTranslation("block", "magic_wall", 0, "");
        addTextPageTranslation("block", "mana_battery", 0, "");
    }
