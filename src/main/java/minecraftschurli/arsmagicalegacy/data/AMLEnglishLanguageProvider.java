...
public class AMLEnglishLanguageProvider extends ArsMagicaLanguageProvider {
    ...
    protected void addTranslations() {
        ...
        addSpellPart(ModSpellParts.BLIZZARD, "Blizzard", "Snow. Lots of snow. TOO MUCH SNOW!");
        ...
        addSpellPart(ModSpellParts.DAYLIGHT, "Daylight", "So... Does that means I can control time?");
        ...
        addSkill(ModSpellParts.MANA_REGEN_1, "Mana Regen I", "You can fell the mana flowing around you...");
        ...
        addSkill(ModSpellParts.SHIELD_OVERLOAD, "Shield Overload", "To much mana? Well it's always a good shield...");
        ...
        addSpellPart(ModSpellParts.SHRINK, "Shrink", "It looks like i'm smaller now...");
        ...
        addSpellPart(ModSpellParts.DROUGHT, "Drought", "Sand. Who doesn't konw that?");
        ...
        addSpellPart(ModSpellParts.INVISIBILITY, "Invisibility", "Wanna play Hide and Seek?");
        ...
        addSpellPart(ModSpellParts.RANGE, "Range", "Think you're far enough? Spoiler : No.");
        ...
        //addSpellPart(ModSpellParts.CONTINGENCY_DEATH, "Contingency : Death", "You're comming with me.");
