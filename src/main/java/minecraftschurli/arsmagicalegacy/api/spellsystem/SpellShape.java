...
public abstract class SpellShape extends SpellPart<SpellShape> {
     ...
     */
    public abstract SpellCastResult beginStackStage(SpellItem item, ItemStack stack, LivingEntity caster, LivingEntity target, World world, Vec3d pos, Direction side, boolean giveXP, int useCount);
     ...
     * @return
     */
    public abstract float getManaCostMultiplier(ItemStack spellStack);
     ...
     */
    //public abstract String getSoundForAffinity(Affinity affinity, ItemStack stack, World world);
}
