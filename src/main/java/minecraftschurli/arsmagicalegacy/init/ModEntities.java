...
public final class ModEntities implements IInit {
    ...
    public static final RegistryObject<EntityType<Entity>> WAVE = ENTITIES.register("wave", () -> EntityType.Builder.create(WaveEntity::new, EntityClassification.MISC).build("wave4"));
