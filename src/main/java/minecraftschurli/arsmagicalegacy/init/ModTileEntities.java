...
import minecraftschurli.arsmagicalegacy.objects.block.blackaurem.BlackAuremTileEntity;
import minecraftschurli.arsmagicalegacy.objects.block.celestialprism.CelestialPrismTileEntity;
...
public final class ModTileEntities implements IInit {
    ...
    public static final RegistryObject<TileEntityType<CelestialPrismTileEntity>> CELESTIAL_PRISM = TILE_ENTITIES.register("celestial_prism", () -> TileEntityType.Builder.create(CelestialPrismTileEntity::new, ModBlocks.CELESTIAL_PRISM.get()).build(null));
    public static final RegistryObject<TileEntityType<BlackAuremTileEntity>> BLACK_AUREM = TILE_ENTITIES.register("black_aurem", () -> TileEntityType.Builder.create(BlackAuremTileEntity::new, ModBlocks.BLACK_AUREM.get()).build(null));
