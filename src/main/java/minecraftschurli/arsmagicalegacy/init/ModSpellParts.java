...
public final class ModSpellParts implements IInit {
    ...
    public static final RegistryObject<SpellModifier> RANGE = SpellRegistry.registerSpellModifier(ArsMagicaAPI.MODID, "range", SKILL_POINT_3, Range::new, ModSkillTrees.UTILITY, 140, 345, "arsmagicalegacy:blink");
    ...
    public static final RegistryObject<SpellComponent> BLINK = SpellRegistry.registerSpellComponent(ArsMagicaAPI.MODID, "blink", SKILL_POINT_2, Blink::new, ModSkillTrees.UTILITY, 185, 345, "arsmagicalegacy:random_teleport");
    ...
    public static final RegistryObject<SpellComponent> TRANSPLACE = SpellRegistry.registerSpellComponent(ArsMagicaAPI.MODID, "transplace", SKILL_POINT_1, Transplace::new, ModSkillTrees.UTILITY, 185, 390, "arsmagicalegacy:blink");
