...
import minecraftschurli.arsmagicalegacy.objects.effect.AgilityEffect;
import minecraftschurli.arsmagicalegacy.objects.effect.AstralDistortionEffect;
import minecraftschurli.arsmagicalegacy.objects.effect.BurnoutReductionEffect;
import minecraftschurli.arsmagicalegacy.objects.effect.ClarityEffect;
import minecraftschurli.arsmagicalegacy.objects.effect.EntangleEffect;
import minecraftschurli.arsmagicalegacy.objects.effect.FlightEffect;
import minecraftschurli.arsmagicalegacy.objects.effect.FrostEffect;
import minecraftschurli.arsmagicalegacy.objects.effect.FuryEffect;
import minecraftschurli.arsmagicalegacy.objects.effect.GravityWellEffect;
import minecraftschurli.arsmagicalegacy.objects.effect.IlluminationEffect;
import minecraftschurli.arsmagicalegacy.objects.effect.InstantManaEffect;
import minecraftschurli.arsmagicalegacy.objects.effect.MagicShieldEffect;
import minecraftschurli.arsmagicalegacy.objects.effect.ManaBoostEffect;
import minecraftschurli.arsmagicalegacy.objects.effect.ManaRegenEffect;
import minecraftschurli.arsmagicalegacy.objects.effect.ScrambleSynapsesEffect;
import minecraftschurli.arsmagicalegacy.objects.effect.ShieldEffect;
import minecraftschurli.arsmagicalegacy.objects.effect.ShrinkEffect;
import minecraftschurli.arsmagicalegacy.objects.effect.SilenceEffect;
import minecraftschurli.arsmagicalegacy.objects.effect.SpellReflectEffect;
import minecraftschurli.arsmagicalegacy.objects.effect.SwiftSwimEffect;
import minecraftschurli.arsmagicalegacy.objects.effect.TemporalAnchorEffect;
import minecraftschurli.arsmagicalegacy.objects.effect.TrueSightEffect;
import minecraftschurli.arsmagicalegacy.objects.effect.WateryGraveEffect;
