...
public class Items implements Registries {
    public static final RegistryObject<Item> SPELL_ITEM = ITEMS.register("spell", SpellItem::new);
    public static final RegistryObject<Item> SPELL_BOOK_ITEM = ITEMS.register("spell_book", SpellBookItem::new);
