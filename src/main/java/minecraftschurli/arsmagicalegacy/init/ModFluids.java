...
public final class ModFluids implements IInit {
    ...
    public static final ForgeFlowingFluid.Properties LIQUID_ESSENCE_PROPERTIES = new ForgeFlowingFluid.Properties(ModFluids.LIQUID_ESSENCE, ModFluids.LIQUID_ESSENCE_FLOWING, FluidAttributes.builder(new ResourceLocation("minecraft", "block/water_still"), new ResourceLocation("minecraft", "block/water_flow")).color(0x74FFFC).luminosity(3)).bucket(ModFluids.LIQUID_ESSENCE_BUCKET).block(LIQUID_ESSENCE_BLOCK);
