...
public final class ModFluids implements IInit {
    ...
    public static final Block.Properties FLUID_BLOCK_PROPERTIES = Block.Properties.create(Material.WATER).doesNotBlockMovement().hardnessAndResistance(100.0F).noDrops();
