...
/*public class ArcaneCompendium implements IArcaneCompendium, ICapabilityProvider, ICapabilitySerializable<INBT> {
	...
	public void init(PlayerEntity player, IDataSyncExtension ext) {
		this.player = player;
		ext.setWithSync(DataDefinitions.COMPENDIUM, new ArrayList<String>());
	}

	public static IArcaneCompendium For(PlayerEntity entityPlayer) {
